...
class H3DAPIConan(ConanFile):
    name = "h3dphysics"
    version = "1.4-beta"
    url = "https://github.com/ulricheck/conan-h3dphysics.git"

    short_paths = True
    settings = "os", "compiler", "build_type", "arch"
    generators = "cmake"
    exports = "FindH3DPhysics.cmake"
    ...
    def source(self):
        repo_url = "https://www.h3dapi.org:8090/H3DPhysics/trunk/H3DPhysics/"
        self.run("svn checkout %s source" % repo_url)
        tools.replace_in_file("source/build/CMakeLists.txt", "project( H3DPhysics )", '''project( H3DPhysics )
...
''')
    ...
    def package(self):
        ...
        self.copy(pattern='*', src="source/examples", dst="examples/h3dphysics", keep_path=False)
